                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="keywords" rows="3" class="col-xs-10 col-sm-5" placeholder="关键词">{{ old('keywords') ? old('keywords') : '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="description" rows="3" class="col-xs-10 col-sm-5" placeholder="描述">{{ old('description') ? old('description') : '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9" style="overflow: auto;">
                                    <script id="content" name="content" type="text/plain">{!! old('content') !!}</script>
                                </div>
                            </div>
