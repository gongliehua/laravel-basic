            ...
            <div class="page-content">
                <div class="page-header">
                    ...
                    <div class="pull-right">
                        ...
                        <a href="{{ url('admin/article/create') }}" class="btn btn-sm btn-success" title="添加"><i class="fa fa-plus"></i><span class="hidden-xs"> 添加</span></a>
                    </div>
                </div><!-- /.page-header -->
                                    ...
                                    @if (count($list) > 0)
                                        @foreach ($list as $key=>$value)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('admin/article/show') }}?id={{ $value->id }}" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a>
                                                    <a href="{{ url('admin/article/update') }}?id={{ $value->id }}" class="btn btn-xs btn-info"><i class="fa fa-edit"></i></a>
                                                    <a href="javascript:void(0)" onclick="confirm('确认删除？')? location.href='{{ url('admin/article/delete') }}?id={{ $value->id }}': ''" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @else
