                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="title" value="{{ $article->title }}" placeholder="标题" class="col-xs-10 col-sm-5" required />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="alias" value="{{ $article->alias }}" placeholder="别名" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="author" value="{{ $article->author }}" placeholder="作者" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="keywords" rows="3" class="col-xs-10 col-sm-5" placeholder="关键词">{{ $article->keywords }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="description" rows="3" class="col-xs-10 col-sm-5" placeholder="描述">{{ $article->description }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="status" value="{{ $article->status_text }}" placeholder="" class="col-xs-10 col-sm-5" required />
                                </div>
                            </div>
