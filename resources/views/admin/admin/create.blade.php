                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="username" value="{{ old('username') ? old('username') : '' }}" placeholder="用户名" class="col-xs-10 col-sm-5" required />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" name="password" value="{{ old('password') }}" placeholder="123456" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" name="password_confirmation" value="{{ old('password_confirmation') }}" placeholder="123456" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name" value="{{ old('name') }}" placeholder="昵称" class="col-xs-10 col-sm-5" required />
                                </div>
                            </div>
